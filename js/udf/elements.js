...
function dataGrid4(headers, data, headerclass, rowclass, lblfunction, divfunction, tableclass) {
    table = document.createElement('table');
    table.setAttribute('class', 'table table-striped table-bordered table-hover table-condensed small')
    table.setAttribute('style', 'padding-left:1.5%;width:97%')
    thead = document.createElement('thead');
    ...
    for (var i = 0; i < headers.length; i++) {
        ...
        td.onclick = divfunction;
        if (headers != undefined){
            if(headers[i] == "BOT USD(m)"){
                td.innerHTML = headers[i] +" <img src='/incogneta/images/help.png' title='Balance Of Trade' width='10px' />"
            }
            else if(headers[i] == "Int. Rate"){
                td.innerHTML = headers[i] +" <img src='/incogneta/images/help.png' title='Interest Rate' width='10px' />"
            }
            else if(headers[i] == "Gov. Budget"){
                td.innerHTML = headers[i] +" <img src='/incogneta/images/help.png' title='Goverment Budget' width='10px' />"
            }
            else if(headers[i] == "Inf. Rate"){
                td.innerHTML = headers[i] +" <img src='/incogneta/images/help.png' title='Inflation Rate' width='10px' />"
            }
            else if(headers[i] == "FDI  USD(m)"){
                td.innerHTML = headers[i] +" <img src='/incogneta/images/help.png' title='Foreign Direct Investment' width='10px' />"
            }
            else if(headers[i] == "CA  USD(m)"){
                td.innerHTML = headers[i] +" <img src='/incogneta/images/help.png' title='Current Account' width='10px' />"
            }
            else if(headers[i] == "xRate USD/RWF"){
                td.innerHTML = headers[i] +" <img src='/incogneta/images/help.png' title='Currency' width='10px' />"
            }else{
                td.innerHTML = headers[i]
            }
        }
